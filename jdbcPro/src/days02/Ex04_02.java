...
public class Ex04_02 {
   public static void main(String[] args) {
      ...
      ArrayList<EmpDeptSalGradelVO> empList = null;  // value      
      EmpDeptSalGradelVO empVo = null;

      LinkedHashMap<SalgradeVO, ArrayList<EmpDeptSalGradelVO>> map = new LinkedHashMap<SalgradeVO, ArrayList<EmpDeptSalgradeVO>>();
   ...
   private static void dispSalgrade(
         LinkedHashMap<SalgradeVO, ArrayList<EmpDeptSalGradelVO>> map) {
      Set<Entry<SalgradeVO, ArrayList<EmpDeptSalGradelVO>>> set = map.entrySet();
      Iterator<Entry<SalgradeVO, ArrayList<EmpDeptSalGradelVO>>> ir = set.iterator();
      while (ir.hasNext()) {
         Entry<SalgradeVO, ArrayList<EmpDeptSalGradelVO>> entry = 
               ir.next();
         SalgradeVO vo =  entry.getKey();
         ArrayList<EmpDeptSalGradelVO> list = entry.getValue();
         // 출력
         System.out.printf("%d등급   ( %d~%d ) - %d명\n"
               ...
               , vo.getCnt());
         // 사원 출력
         Iterator<EmpDeptSalGradelVO> ir2 = list.iterator();
         while (ir2.hasNext()) {
            EmpDeptSalGradelVO empvo = ir2.next();
            System.out.printf(
                  "\t\t%s\t%d\t%s\t%.2f\n"
                  , empvo.getDname()
                  , empvo.getEmpno()
